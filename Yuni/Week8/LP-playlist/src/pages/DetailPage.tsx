      ...
      likeToggle({ action: 'add' }, {
        onError: (likeError: any) => {
          if (likeError.response?.status === 409) {
            setActionMessage('이미 좋아요한 LP입니다');
          } else {
  ...
  return (
    <div className="min-h-screen bg-black text-white py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {/* 업로드 날짜 (맨 위) */}
        <div className="mb-6 text-right text-gray-400 text-sm">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-3">
            <button
              onClick={handleEdit}
              className="p-2 hover:bg-blue-700 text-white transition"
              title="수정"
            >
              ✏️
            </button>
            <button
              ...
              className="p-2 hover:bg-red-700 text-white transition"
              title="삭제"
            >
              🗑️
            </button>
        ...
        {lp.tags && lp.tags.length > 0 && (
          <div className="mb-6">
            <p className="text-sm text-gray-400 mb-2 text-center">🏷️ 태그</p>
        ...
        {actionMessage && (
          <div className="bg-gray-800 rounded-lg p-4 mb-6 border border-gray-700">
            <p className="text-sm font-mono text-gray-300 text-center">{actionMessage}</p>
          </div>
        )}
