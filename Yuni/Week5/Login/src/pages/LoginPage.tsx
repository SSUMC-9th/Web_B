...
export default function LoginPage() {
    ...
    const handleGoogleLogin = () => {
        console.log('🔗 Google 로그인 페이지로 리다이렉트:', GOOGLE_LOGIN_URL);
      ...
      <main className="flex flex-col items-center justify-center min-h-[calc(100vh-80px)] px-4">
        <div className="w-full max-w-md">
          ...
          <button
            ...
            className={`w-full flex items-center justify-center gap-3 px-6 py-3 rounded-lg transition mb-6 ${
              isSubmitting
          ...
          >
            ...
            <span className="font-medium">{isSubmitting ? '로그인 중...' : '구글 로그인'}</span>
          </button>
